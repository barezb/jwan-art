...
export default function About({ settings }: AboutProps) {
  ...
  return (
    <Layout settings={settings}>
      {/* Hero Section */}
      <section className="pt-24 pb-16 bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-black dark:via-gray-900 dark:to-black min-h-screen flex items-center transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-white dark:bg-gradient-to-br dark:from-purple-900/30 dark:to-pink-900/30 backdrop-blur-sm border border-gray-200 dark:border-white/10 rounded-2xl p-6 text-center">
            ...
            <div className="relative">
              ...
              <div className="relative bg-white dark:bg-gradient-to-br dark:from-gray-800/50 dark:to-gray-900/50 backdrop-blur-sm border border-gray-200 dark:border-white/10 rounded-3xl p-8 text-center">
              ...
              {timelineEvents.map((event, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className="bg-white dark:bg-gradient-to-br dark:from-purple-900/30 dark:to-pink-900/30 backdrop-blur-sm border border-gray-200 dark:border-white/10 rounded-2xl p-6">
                        <div
                    ...
                    {/* Timeline Dot */}
                    <div className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-gradient-to-br from-purple-600 to-pink-600 rounded-full border-4 border-white dark:border-black" />
                  </div>
                );
              })}
            </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gradient-to-b dark:from-gray-900 dark:to-black transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gradient-to-br dark:from-purple-900/30 dark:to-pink-900/30 backdrop-blur-sm border border-gray-200 dark:border-white/10 rounded-2xl p-8 text-center">
      ...
      <section className="py-20 bg-white dark:bg-gradient-to-b dark:from-black dark:to-gray-900 transition-colors duration-300">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gray-50 dark:bg-gradient-to-br dark:from-purple-900/30 dark:to-pink-900/30 backdrop-blur-sm border border-gray-200 dark:border-white/10 rounded-3xl p-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="/gallery"
                className="border-2 border-gray-300 dark:border-white/30 text-gray-700 dark:text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 hover:bg-gray-100 dark:hover:bg-white/10 hover:border-purple-600 dark:hover:border-white/50 backdrop-blur-sm"
              >
                View My Work
              </a>
            </div>
